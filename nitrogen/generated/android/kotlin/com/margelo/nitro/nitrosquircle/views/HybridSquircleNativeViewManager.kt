///
/// HybridSquircleNativeViewManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitrosquircle.views
...
import com.margelo.nitro.nitrosquircle.*

/**
 * Represents the React Native `ViewManager` for the "SquircleNativeView" Nitro HybridView.
 */
public class HybridSquircleNativeViewManager: SimpleViewManager<View>() {
  /**
  ...
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridSquircleNativeView::class.java)) {
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridSquircleNativeViewStateUpdater.updateViewProps(hybridView, newState, oldState)
